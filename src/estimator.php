...
$SevereImpact_currentlyInfected = $data['reportedCases']*50;
  ...
  switch ($data["periodType"]) {
    ...
    default:
      $Impact_infectionsByRequestedTime = 0;
      break;
  }
  ...
  switch ($data["periodType"]) {
    ...
    default:
      $SevereImpact_infectionsByRequestedTime = 0;
      break;
  }
  ...
  $Impact_hospitalBedsByRequestedTime = floor($data["totalHospitalBeds"] * 0.35 ) - $Impact_severeCasesByRequestedTime;
  $Severe_hospitalBedsByRequestedTime = floor($data["totalHospitalBeds"] * 0.35 ) - $Severe_severeCasesByRequestedTime;
      //Question 3
